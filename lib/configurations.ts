...
export const configDefinitions: Record<ConfigSection, ConfigDefinition> = {
  ...
  marketplace: {
    ...
    keyField: "id",
    searchFields: ["name", "marketplace", "account_id", "seller_id", "shop_id", "nickname", "email", "category_id"],
    listFields: ["name", "marketplace", "seller_id", "shop_id", "nickname", "email", "status", "active", "last_sync_at", "last_error"],
    ...
    fields: [
      ...
      { name: "shop_id", label: "Shop ID (Shopee)", type: "text" },
      { name: "nickname", label: "Nickname/Nome loja", type: "text" },
      { name: "email", label: "Email", type: "text" },
      { name: "status", label: "Status conexao", type: "text" },
      { name: "category_id", label: "Categoria padrao", type: "text" },
      { name: "client_id", label: "Client ID / App ID / Partner ID", type: "text" },
      { name: "client_secret", label: "Client Secret / Partner Key", type: "text" },
      { name: "redirect_uri", label: "Redirect URI HTTPS", type: "text" },
      { name: "api_base_url", label: "API Base URL (Shopee)", type: "text" },
      ...
      { name: "last_sync_at", label: "Ultima sincronizacao", type: "text" },
