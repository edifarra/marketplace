...
function activityLabel(value:string){return ({stock_update:"Atualizar estoque",listing_create:"Incluir anúncio",listing_update:"Atualizar atributos",listing_delete:"Excluir anúncio"} as Record<string,string>)[value] || value;}
