-- As categorias efetivas pertencem a cada marketplace. Um vinculo em um canal
-- nao deve impedir a edicao da categoria de outro canal sem anuncio.
...
-- Corrige o snapshot que usava uma descricao sem mapeamento. Os codigos dos
-- marketplaces permanecem inalterados.
update public.products
set marketplace_categories = jsonb_set(
      marketplace_categories,
      '{internal_category}',
      to_jsonb('Placa Principal'::text),
      true
    ),
    updated_at = now()
